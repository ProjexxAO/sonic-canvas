...
export function WelcomeScreen({
  ...
  return <div className="h-full flex flex-col items-center justify-center px-6 animate-fade-in">
      {/* Skip button */}
      ...
      {/* Title */}
      <h1 className="text-3xl font-bold mb-3 text-center bg-accent text-secondary-glow">Welcome to Atlas</h1>
      ...
      <div className="grid grid-cols-3 gap-4 mb-10 max-w-lg">
        <FeaturePreview number="1" title="Connect" description="Link your data sources" />
        <FeaturePreview number="2" title="Configure" description="Choose your persona" />
        <FeaturePreview number="3" title="Generate" description="Get AI briefings" />
      </div>
...
function FeaturePreview({
  ...
  return <div className="text-center p-3 rounded-lg bg-card border border-border">
