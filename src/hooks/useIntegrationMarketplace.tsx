...
const INTEGRATION_CATALOG: Integration[] = [
  ...
  { id: 'zapier', name: 'Zapier', shortDescription: 'Connect 7000+ apps', description: 'The most popular automation platform. Create "Zaps" to connect Atlas with 7000+ apps. Trigger workflows when events happen in Atlas, or send data to external services.', icon: '⚡', category: 'automation', subcategory: 'workflows', provider: 'Zapier', authType: 'webhook', status: 'available', popularity: 96, features: ['7000+ app integrations', 'Multi-step Zaps', 'Conditional logic', 'Webhooks', 'Scheduled triggers', 'Filters & formatters'], capabilities: [{ name: 'Trigger Zaps', type: 'trigger', description: 'Send events to Zapier webhooks' }, { name: 'Receive data', type: 'action', description: 'Receive data from Zapier into Atlas' }], pricing: 'freemium', setupTime: '2 min', docsUrl: 'https://zapier.com/help', supportedActions: ['trigger_webhook', 'send_data', 'create_zap'], supportedTriggers: ['webhook_received', 'zap_triggered', 'task_completed', 'event_created'] },
  { id: 'make', name: 'Make (Integromat)', shortDescription: 'Visual automation builder', description: 'Powerful visual automation platform with advanced branching, loops, and data transformation. Build complex multi-step scenarios connecting Atlas to hundreds of services.', icon: '🔧', category: 'automation', subcategory: 'workflows', provider: 'Make', authType: 'webhook', status: 'available', popularity: 91, features: ['Visual scenario builder', 'Advanced branching logic', 'Data mapping & transformation', 'Error handling', 'Real-time execution', 'Custom HTTP modules'], capabilities: [{ name: 'Trigger scenarios', type: 'trigger', description: 'Send events to Make webhooks' }, { name: 'HTTP integration', type: 'action', description: 'Receive API calls from Make' }], pricing: 'freemium', setupTime: '3 min', docsUrl: 'https://www.make.com/en/help', supportedActions: ['trigger_scenario', 'send_data', 'http_request'], supportedTriggers: ['webhook_received', 'scenario_triggered', 'schedule'] },
  { id: 'n8n', name: 'n8n', shortDescription: 'Open-source & self-hosted', description: 'Self-hosted, open-source workflow automation. Full control over your data with 400+ integrations. Perfect for privacy-conscious teams and custom enterprise deployments.', icon: '🔄', category: 'automation', subcategory: 'open-source', provider: 'n8n', authType: 'webhook', status: 'available', popularity: 88, features: ['Self-hosted option', 'Open-source', '400+ integrations', 'Custom code nodes', 'AI capabilities', 'Credential encryption'], capabilities: [{ name: 'Trigger workflows', type: 'trigger', description: 'Send events to n8n webhooks' }, { name: 'Execute code', type: 'action', description: 'Run custom JavaScript/Python' }], pricing: 'freemium', setupTime: '5 min', docsUrl: 'https://docs.n8n.io', supportedActions: ['trigger_workflow', 'send_data', 'execute_code'], supportedTriggers: ['webhook_received', 'workflow_triggered', 'cron_schedule'] },
  { id: 'ifttt', name: 'IFTTT', shortDescription: 'Simple automation', description: 'Simple "If This Then That" automation for personal and smart home use cases. Connect Atlas to IoT devices, social media, and everyday apps.', icon: '🔗', category: 'automation', subcategory: 'simple', provider: 'IFTTT', authType: 'webhook', status: 'available', popularity: 84, features: ['Simple applets', 'Smart home integration', 'Social media triggers', 'Location triggers', 'Mobile notifications'], capabilities: [{ name: 'Trigger applets', type: 'trigger', description: 'Send events to IFTTT webhooks' }], pricing: 'freemium', setupTime: '2 min', docsUrl: 'https://ifttt.com/docs', supportedActions: ['trigger_webhook'], supportedTriggers: ['webhook_received'] },
  { id: 'power_automate', name: 'Power Automate', shortDescription: 'Microsoft automation', description: 'Microsoft\'s enterprise automation platform. Deep integration with Office 365, Dynamics, and Azure. Ideal for Microsoft-centric organizations.', icon: '⚙️', category: 'automation', subcategory: 'enterprise', provider: 'Microsoft', authType: 'oauth2', status: 'available', popularity: 87, features: ['Office 365 integration', 'Desktop flows (RPA)', 'AI Builder', 'Cloud flows', 'Business process flows', 'Approvals'], capabilities: [{ name: 'Trigger flows', type: 'trigger', description: 'Send events to Power Automate' }, { name: 'HTTP connector', type: 'action', description: 'Receive calls from flows' }], pricing: 'freemium', setupTime: '5 min', docsUrl: 'https://docs.microsoft.com/power-automate', supportedActions: ['trigger_flow', 'send_data', 'approval_request'], supportedTriggers: ['webhook_received', 'flow_triggered'] },
